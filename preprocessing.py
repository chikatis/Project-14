...
variation_folder_path = './Data/2015/variations'
...
# variation_df.to_csv('./Data/2015/variations/Combined 2015 Variations Data.csv', index=False)
...
variation_df_B.to_csv('./Data/2015/variations/div-b/Cleaned 2015 DivB Variations.csv', index=False)


divb_path = './Data/2015/variations/div-b'
...
on_train.to_csv('./Data/2015/pt-train-test-sets/ON Train.csv', index=False)
