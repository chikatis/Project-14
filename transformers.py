        ...
        for folder in folders:
            ...
            for file in os.listdir(f'{full_code_2015}/{code_type}'):
                if file != f'2015 National {code_type.capitalize()}.csv':
                    ...
                    aer, correct_alignments, predicted_alignments, actual_alignments = calculate_alignment_error_rate(test_alignments_df, test_df, code_book=f'{code_type.capitalize()}', train=False, pt=f'{pt}', model_name=model, model_type=model_type)
...
model_names = ['Lajavaness/bilingual-embedding-large', 'intfloat/multilingual-e5-large-instruct', 'mixedbread-ai/mxbai-embed-large-v1']
